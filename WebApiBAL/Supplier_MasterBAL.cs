...
using WebApiHelper;
/// <summary>
/// Summary description for Supplier_MasterBAL
/// </summary>
namespace WebApiBAL 
{
    public class Supplier_MasterBAL  : IBaseBAL<Supplier_MasterDTO>,IDisposable
    {
    	#region Private Variables
		//readonly Supplier_MasterDAL objSupplier_MasterDAL;
		ResultPT objResultPT;
		#endregion
		
        #region Public Constructors
        public Supplier_MasterBAL()
        {
            //
            // TODO: Add constructor logic here
            //
            //objSupplier_MasterDAL=new Supplier_MasterDAL();
        }
        #endregion       

        #region Public Methods
        public async Task<ResultPT> InsertAsync(Supplier_MasterDTO objSupplier_MasterDTO)
        { 
			try
            {
                ...
                {
                    objResultPT.ReturnObject = await objSupplier_MasterDAL.InsertAsync(objSupplier_MasterDTO);
                    if (Convert.ToInt32(objResultPT.ReturnObject) == 2)
                    {
                        objResultPT.ResultMsg = string.Format(Messages.ObjectExist, "Supplier_Master");
        ...
        public async Task<ResultPT> UpdateAsync(Supplier_MasterDTO objSupplier_MasterDTO)
        {
			try
            {
				objResultPT = new ResultPT();
				using (Supplier_MasterDAL objSupplier_MasterDAL = new Supplier_MasterDAL())
                {
                    objResultPT.ReturnObject = await objSupplier_MasterDAL.UpdateAsync(objSupplier_MasterDTO);
                    if (Convert.ToInt32(objResultPT.ReturnObject) == 2)
                    {
                        objResultPT.ResultMsg = string.Format(Messages.ObjectExist, "Supplier_Master");
                        objResultPT.TransactionStatus = Enums.ResultStatus.Warning;
        ...
        public async Task<ResultPT> DeleteAsync(long ID)
        {
			try
            {
				...
				using (Supplier_MasterDAL objSupplier_MasterDAL = new Supplier_MasterDAL())
                {
                    objResultPT.ReturnObject = await objSupplier_MasterDAL.DeleteAsync(ID);
...
////			using (Supplier_MasterDAL objSupplier_MasterDAL = new Supplier_MasterDAL())
////            {
////                 objResultPT.ReturnObject = objSupplier_MasterDAL.DeleteAll();
////                objResultPT.TransactionStatus = Enums.ResultStatus.Success;
...
////    }
        ...
        public async Task<ResultPT> GetAllAsync( )
        {
			try
            {
				...
				using (Supplier_MasterDAL objSupplier_MasterDAL = new Supplier_MasterDAL())
                {
                    objResultPT.ReturnObject = await objSupplier_MasterDAL.GetAllAsync();                   
                }
				return objResultPT;
			}
            catch (Exception Ex)
  ...
  //          using (Supplier_MasterDAL objSupplier_MasterDAL = new Supplier_MasterDAL())
  //          {
  //              return await objSupplier_MasterDAL.FilterAsync(param);
  //          }
  //      }
