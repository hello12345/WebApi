...
/// <summary>
/// Summary description for Stock_Transaction_MasterBAL
/// </summary>
namespace WebApiBAL 
{
    public class Stock_Transaction_MasterBAL  : IBaseBAL<Stock_Transaction_MasterDTO>,IDisposable
    {
    	#region Private Variables
		//readonly Stock_Transaction_MasterDAL objStock_Transaction_MasterDAL;
		ResultPT objResultPT;
		#endregion
		
        #region Public Constructors
        public Stock_Transaction_MasterBAL()
        {
            //
            // TODO: Add constructor logic here
            //
            //objStock_Transaction_MasterDAL=new Stock_Transaction_MasterDAL();
        }
        #endregion       

        #region Public Methods
        public async Task<ResultPT> InsertAsync(Stock_Transaction_MasterDTO objStock_Transaction_MasterDTO)
        { 
			try
            {
                ...
                {
                    objResultPT.ReturnObject = await objStock_Transaction_MasterDAL.InsertAsync(objStock_Transaction_MasterDTO);
                    if (Convert.ToInt32(objResultPT.ReturnObject) == 2)
                    {
                        objResultPT.ResultMsg = string.Format(Messages.ObjectExist, "Stock_Transaction_Master");
        ...
        public async Task<ResultPT> UpdateAsync(Stock_Transaction_MasterDTO objStock_Transaction_MasterDTO)
        {
			try
            {
				objResultPT = new ResultPT();
				using (Stock_Transaction_MasterDAL objStock_Transaction_MasterDAL = new Stock_Transaction_MasterDAL())
                {
                    objResultPT.ReturnObject = await objStock_Transaction_MasterDAL.UpdateAsync(objStock_Transaction_MasterDTO);
                    if (Convert.ToInt32(objResultPT.ReturnObject) == 2)
                    {
                        objResultPT.ResultMsg = string.Format(Messages.ObjectExist, "Stock_Transaction_Master");
                        objResultPT.TransactionStatus = Enums.ResultStatus.Warning;
        ...
        public async Task<ResultPT> DeleteAsync(long ID)
        {
			try
            {
				...
				using (Stock_Transaction_MasterDAL objStock_Transaction_MasterDAL = new Stock_Transaction_MasterDAL())
                {
                    objResultPT.ReturnObject = await objStock_Transaction_MasterDAL.DeleteAsync(ID);
...
////			using (Stock_Transaction_MasterDAL objStock_Transaction_MasterDAL = new Stock_Transaction_MasterDAL())
////            {
////                 objResultPT.ReturnObject = objStock_Transaction_MasterDAL.DeleteAll();
////                objResultPT.TransactionStatus = Enums.ResultStatus.Success;
...
////    }
        ...
        public async Task<ResultPT> GetAllAsync( )
        {
			try
            {
				...
				using (Stock_Transaction_MasterDAL objStock_Transaction_MasterDAL = new Stock_Transaction_MasterDAL())
                {
                    objResultPT.ReturnObject = await objStock_Transaction_MasterDAL.GetAllAsync();                   
                }
				return objResultPT;
			}
            catch (Exception Ex)
