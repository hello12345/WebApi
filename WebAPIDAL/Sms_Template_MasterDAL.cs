...
using WebApiModel;
/// <summary>
/// Summary description for Sms_Template_MasterDAL
/// </summary>
namespace WebApiDAL
{
    
    public class Sms_Template_MasterDAL  : BaseDAL<Sms_Template_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Sms_Template_MasterFilter = "Sms_Template_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Sms_Template_MasterFilter, Sqlparam);
