...
using WebApiModel;
/// <summary>
/// Summary description for Sales_DetailsDAL
/// </summary>
namespace WebApiDAL 
{
    
    public class Sales_DetailsDAL  : BaseDAL<Sales_DetailsDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Sales_DetailsFilter = "Sales_DetailsFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Sales_DetailsFilter, Sqlparam);
...
//					   x.Field<long>("Sales_Details_Id"),
//x.Field<int>("Sales_Id"),
