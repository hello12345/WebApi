...
using WebApiModel;
/// <summary>
/// Summary description for Supplier_MasterDAL
/// </summary>
namespace WebApiDAL 
{
    
    public class Supplier_MasterDAL  : BaseDAL<Supplier_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Supplier_MasterFilter = "Supplier_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Supplier_MasterFilter, Sqlparam);
...
//					   x.Field<int>("Supplier_Id"),
//x.Field<string>("Supplier_First_Name"),
//x.Field<string>("Supplier_Last_Name"),
//x.Field<string>("Supplier_Address"),
//x.Field<int>("Gender_Id"),
//x.Field<decimal>("Amount"),
//x.Field<string>("Supplier_Number"),
//x.Field<string>("Supplier_Email"),
//x.Field<bool>("Send_Sms"),
//x.Field<bool>("Send_Email"),
//x.Field<datetime>("DOB"),
//x.Field<datetime>("DOA"),
//x.Field<bool>("Send_Greeting_Sms"),
//x.Field<bool>("Send_Greeting_Email"),
//x.Field<string>("City"),
