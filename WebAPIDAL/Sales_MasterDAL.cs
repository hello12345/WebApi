...
using WebApiModel;
/// <summary>
/// Summary description for Sales_MasterDAL
/// </summary>
namespace WebApiDAL
{
    
    public class Sales_MasterDAL  : BaseDAL<Sales_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Sales_MasterFilter = "Sales_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Sales_MasterFilter, Sqlparam);
