...
using WebApiModel;
/// <summary>
/// Summary description for Transaction_MasterDAL
/// </summary>
namespace WebApiDAL
{
    
    public class Transaction_MasterDAL  : BaseDAL<Transaction_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Transaction_MasterFilter = "Transaction_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Transaction_MasterFilter, Sqlparam);
...
//					   x.Field<long>("Trans_Id"),
//x.Field<int>("Trans_Type"),
//x.Field<int>("Customer_Id"),
//x.Field<decimal>("Trans_Amount"),
