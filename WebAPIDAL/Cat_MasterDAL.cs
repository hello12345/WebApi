...
using WebApiModel;
/// <summary>
/// Summary description for Cat_MasterDAL
/// </summary>
namespace WebApiDAL 
{
    
    public class Cat_MasterDAL  : BaseDAL<Cat_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Cat_MasterFilter = "Cat_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Cat_MasterFilter, Sqlparam);
...
//					   x.Field<int>("Cat_Id"),
//x.Field<string>("Cat_Name"),
//x.Field<int>("Cat_Type"),
