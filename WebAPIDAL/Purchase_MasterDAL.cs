...
using WebApiModel;
/// <summary>
/// Summary description for Purchase_MasterDAL
/// </summary>
namespace WebApiDAL 
{
    
    public class Purchase_MasterDAL  : BaseDAL<Purchase_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Purchase_MasterFilter = "Purchase_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Purchase_MasterFilter, Sqlparam);
...
//x.Field<datetime>("Purchase_Date"),
