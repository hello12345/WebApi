...
using WebApiModel;
/// <summary>
/// Summary description for Service_MasterDAL
/// </summary>
namespace WebApiDAL
{
    
    public class Service_MasterDAL  : BaseDAL<Service_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Service_MasterFilter = "Service_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Service_MasterFilter, Sqlparam);
