...
using WebApiModel;
/// <summary>
/// Summary description for Product_MasterDAL
/// </summary>
namespace WebApiDAL
{
    
    public class Product_MasterDAL  : BaseDAL<Product_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Product_MasterFilter = "Product_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Product_MasterFilter, Sqlparam);
