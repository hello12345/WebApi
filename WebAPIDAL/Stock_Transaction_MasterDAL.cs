...
using WebApiModel;
/// <summary>
/// Summary description for Stock_Transaction_MasterDAL
/// </summary>
namespace WebApiDAL
{
    
    public class Stock_Transaction_MasterDAL  : BaseDAL<Stock_Transaction_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Stock_Transaction_MasterFilter = "Stock_Transaction_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Stock_Transaction_MasterFilter, Sqlparam);
...
//					   x.Field<long>("St_Trans_Id"),
//x.Field<int>("Product_Id"),
//x.Field<decimal>("Trans_Qty"),
//x.Field<decimal>("Trans_Base_Amount"),
//x.Field<decimal>("Trans_Total_Amount"),
//x.Field<long>("Unique_Id"),
//x.Field<string>("Unique_For"),
