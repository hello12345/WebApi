...
using WebApiModel;
/// <summary>
/// Summary description for Service_Sales_DetailsDAL
/// </summary>
namespace WebApiDAL 
{
    
    public class Service_Sales_DetailsDAL  : BaseDAL<Service_Sales_DetailsDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Service_Sales_DetailsFilter = "Service_Sales_DetailsFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Service_Sales_DetailsFilter, Sqlparam);
...
//					   x.Field<long>("Service_Sales_Details_Id"),
//x.Field<int>("Service_Sales_Id"),
//x.Field<int>("Service_Id"),
//x.Field<decimal>("Qty"),
