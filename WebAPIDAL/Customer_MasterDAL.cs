...
/// <summary>
/// Summary description for Customer_MasterDAL
/// </summary>
namespace WebApiDAL
{
    
    public class Customer_MasterDAL  : BaseDAL<Customer_MasterDTO>,IDisposable
    {
	...
	#region IDisposable Support
		...
		public const string SP_Customer_MasterFilter = "Customer_MasterFilter";    
...
//            DataSet dset = await SqlHelper.ExecuteDatasetAsync(DBConStr, SPConstant.SP_Customer_MasterFilter, Sqlparam);
...
//x.Field<string>("Customer_First_Name"),
//x.Field<string>("Customer_Last_Name"),
//x.Field<string>("Customer_Address"),
//x.Field<int>("Gender_Id"),
//x.Field<decimal>("Amount"),
//x.Field<string>("Customer_Number"),
//x.Field<string>("Customer_Email"),
